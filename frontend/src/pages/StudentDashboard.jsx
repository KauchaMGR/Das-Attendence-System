              ...
              <Card title="This semester" sub="Overall standing across all enrolled subjects">
                <div className="flex items-center gap-5">
                  ...
                  <div className="space-y-1.5 text-[13px]">
                    <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-[2px] bg-stamp-green" />Present — {student.present} days</div>
                    <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-[2px] bg-stamp-amber" />Late — {student.late} days</div>
                    <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-[2px] bg-paper2" />Absent — {student.absent} days</div>
                  </div>
                </div>
              </Card>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <Card title="Last 14 days" sub="Daily presence">
                ...
                <div className="flex gap-4 mt-4 font-mono text-[10.5px] text-muted">
                  ...
                  <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-[2px] bg-stamp-amber" />Late</span>
